...
| H4 generated asset intake | Main implementation with safety, art-readability, and UX reviewer lanes | Done for quarantine gate | `docs/kiln-asset-intake.md` plus `npm run proof:kiln-assets` validate 64 local generated GLBs, detect no secrets/presigned URLs, record 28 runtime-readiness warnings, and defer GLB runtime import |
