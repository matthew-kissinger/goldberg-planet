...
| H5 | The approved Kiln pack replaces janky procedural visuals across the world | Active; K1/K10 pickup/drop skins, K2/K3/K4/K5 repeated/static-family slices, K6 animated-creature skin slice, K6T targetability, K6R roaming, K7 cave-anchor/crater/shrine slice, K9 fish, K11 sky life, and C6 edge-socket wall-shell slice passing | Main orchestrator plus asset-runtime, batching/perf, animation, UX, and proof lanes | H4, A4 | R4, R5 | `docs/kiln-pack-adoption-plan.md`; `npm run proof:k10-resource-drops`; `npm run proof:k1-resource-drops`; `npm run proof:k2-domain-resources`; `npm run proof:k3-home-props`; `npm run proof:k4-utilities`; `npm run proof:k5-trees`; `npm run proof:k6-creatures`; `npm run proof:k7-native-targeting`; `npm run proof:k6r-roaming`; `npm run proof:k7-wonders`; `npm run proof:k9-fish-visuals`; `npm run proof:k11-sky-life`; `npm run proof:c6-wall-shells`; current evidence proves waystone and cave-anchor route-marker skins, three skyfall crater skins, all 12 shrine landmark skins, door/window/roof skins, seven home/camp prop skins, seven utility/waterline skins, all 11 exact pickup/drop skins plus a seed alias, all 12 domain resource node skins, four tree/shrub vegetation skins, all nine native-creature skins, native creature targeting/build blockers, sparse creature roaming, five fish/driftjelly bodies, four bird bodies, and edge-addressed code-owned foundations/walls/integrated openings/corners/rails/roof joins | Continue with edge-based shelter coverage/collision, future ore/resource expansion, shared-scale house-shell skins, and avatar/equipment authored assets |
