...
| H5 approved Kiln pack adoption | Main orchestrator with asset-runtime, batching/perf, animation, UX, and proof lanes | Active goal-level priority; K1 pickups, K2 resource nodes, K3 home/camp props, K4 utility/waterline props, K5 trees, K6 native-creature skins, K6T native targetability, K6R roaming, K7 cave-anchor/crater/shrine shells, K9 fish visuals, K11 sky life, and C6 edge-socket wall-shell slice passing | `docs/kiln-pack-adoption-plan.md` makes the 70 ready GLBs the target visual backlog; every asset family must become runtime wired, runtime dressing, regenerated, or explicitly superseded; repeated families must use palette/material reuse, instanced or batched geometry, and distance-gated animation before broad rollout; `npm run proof:k1-resource-drops` proves pickup skins; `npm run proof:k2-domain-resources` proves resource nodes; `npm run proof:k3-home-props` proves seven home/camp structure skins with state overlays preserved; `npm run proof:k4-utilities` proves seven utility/waterline skins with code-owned state overlays and shore blockers preserved; `npm run proof:k5-trees` proves trees/shrubs; `npm run proof:k6-creatures` proves creature skins and animation bands; `npm run proof:k7-native-targeting` proves native creature picks beat terrain mining and occupied native-life tiles block structure placement; `npm run proof:k6r-roaming` proves sparse roaming actors over approved creature skins; `npm run proof:route-markers` proves cave-anchor route-marker GLBs; `npm run proof:k7-wonders` proves all three crater shell GLBs plus all 12 shrine landmark GLBs with code-owned overlays preserved; `npm run proof:k9-fish-visuals` proves promoted cave-fish GLB anchors and point-school rendering; `npm run proof:k11-sky-life` proves all four promoted bird GLBs as sky-life anchors plus point flocks; `npm run proof:c6-wall-shells` proves the expanded edge-addressed code-owned wall-shell catalog that future house GLBs must skin rather than replace |
...
| H5 | The approved Kiln pack replaces janky procedural visuals across the world | Active; K1/K2/K3/K4/K5 repeated/static-family slices, K6 animated-creature skin slice, K6T targetability, K6R roaming, K7 cave-anchor/crater/shrine slice, K9 fish, K11 sky life, and C6 edge-socket wall-shell slice passing | Main orchestrator plus asset-runtime, batching/perf, animation, UX, and proof lanes | H4, A4 | R4, R5 | `docs/kiln-pack-adoption-plan.md`; `npm run proof:k1-resource-drops`; `npm run proof:k2-domain-resources`; `npm run proof:k3-home-props`; `npm run proof:k4-utilities`; `npm run proof:k5-trees`; `npm run proof:k6-creatures`; `npm run proof:k7-native-targeting`; `npm run proof:k6r-roaming`; `npm run proof:k7-wonders`; `npm run proof:k9-fish-visuals`; `npm run proof:k11-sky-life`; `npm run proof:c6-wall-shells`; current evidence proves waystone and cave-anchor route-marker skins, three skyfall crater skins, all 12 shrine landmark skins, door/window/roof skins, seven home/camp prop skins, seven utility/waterline skins, wood/ore pickup skins, all 12 domain resource node skins, four tree/shrub vegetation skins, all nine native-creature skins, native creature targeting/build blockers, sparse creature roaming, five fish/driftjelly bodies, four bird bodies, and edge-addressed code-owned foundations/walls/integrated openings/corners/rails/roof joins | Continue with edge-based shelter coverage/collision, K10 pickup/ore expansion, shared-scale house-shell skins, and avatar/equipment authored assets |
